 ...
 * D:\00_WP\xampp\htdocs\0\wp-content\themes\kasax_child\lib\html\Laravel_search_page.php *
*/
  ...
  $kx_categories = KxSu::get('titile_name');
  if ( !empty($kx_categories) ) :
    $str = '';
        foreach ( $kx_categories as $cat_name => $cat_data )
        {
